    ...
    <section class="content">
      <div class="container-fluid">
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form id="form-cadastro" method="POST" enctype="multipart/form-data" action="salvar.php">
              <div class="row">
                  <div class="col-md-4">
                    <div class="picture">
                        <img style="width: 200px; height: 200px;" src="../../user_images/defaultuser.png" alt="user_image">
                  ...
                  <div class="col-md-8">
                      <div class="row">
                          <div class="col-md-6">
                            ...
                            <input class="form-control" type="text" name="usuario_nome" id="usuario_nome" required>
                          </div>
                          <div class="col-md-3">
                            ...
                            <input class="form-control" type="text" name="usuario_cpf" id="usuario_cpf"  required>
                          </div>
                          <div class="col-md-3">
                            <label class="form-label" for="">Telefone:</label>
                            <input class="form-control" type="text" name="usuario_telefone" id="usuario_telefone" required>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6">
                              <label class="form-label" for="">E-mail:</label>
                              <input class="form-control" name="usuario_email" id="usuario_email" type="text" required>
                          </div>
                          <div class="col-md-3">
                              <label class="form-label" for="">Senha:</label>
                              <input class="form-control" name="usuario_senha" id="usuario_senha" type="text" required>
                          </div>
                          <div class="col-md-3">
                              <label class="form-label" for="">Repetir senha:</label>
                              <input class="form-control" name="usuario_senha" id="usuario_senha_repetir" type="text" required>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-4">
                              <label class="form-label" for="">CEP:</label>
                              <input class="form-control" type="text" name="usuario_cep" id="usuario_cep" required>
                          </div>
                          <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" id="usuario_cidade" name="usuario_cidade" type="text" required>
                        </div>
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            ...
                            <input class="form-control" id="usuario_bairro" name="usuario_bairro" type="text" required>
                          </div>
                          <div class="col-md-6">
                            <label class="form-label" for="">Rua:</label>
                            <input class="form-control" id="usuario_rua" name="usuario_rua" type="text" required>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-2">
                              <label class="form-label" for="">Número:</label>
                              <input class="form-control" type="text" name="usuario_numero" id="usuario_numero" required>
                          </div>
                          <div class="col-md-10">
                              <label class="form-label" for="">Complemento:</label>
                              <input class="form-control" type="text" name="usuario_complemento" id="usuario_complemento" required>
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-3">
