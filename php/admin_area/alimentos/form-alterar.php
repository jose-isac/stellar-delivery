...
if (isset($_GET['alimento'])){
  ...
  $sql = "SELECT * FROM tb_alimentos WHERE alimento_id = '$alimento_id'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Alterar alimento</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form id="form-alterar" method="POST" enctype="multipart/form-data" action="alterar.php">
              <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="picture">
                        <img style="width: 250px; height: 250px;" src="../../food_images/<?php 

                          $img = $linha['alimento_imagem'];

                          if (!$img) {
                            echo 'defaultfood.png';
                          } else {
                            echo $linha['alimento_imagem'];
                          }
                  ...
                  <div class="col-md-8">
                      <div class="row">
                          <div class="col-md-12">
                            <label class="form-label" for="">Alimento ID:</label>
                            <input class="form-control" id="alimento_id" name="alimento_id" required value="<?php echo $linha['alimento_id'] ?>" readonly type="text">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-8">
                            <label class="form-label" for="">Nome:</label>
                            <input class="form-control" type="text" name="alimento_nome" id="alimento_nome" value="<?php echo $linha['alimento_nome']?>" required>
                          </div>
                          <div class="col-md-4">
                            <label class="form-label" for="">Categoria:</label>
                            <select class="form-control" name="alimento_categoria" id="alimento_categoria">
                                <option value="<?php echo $linha['alimento_categoria']?>"><?php echo $linha['alimento_categoria']?></option>
                                <option value=""></option>
                      ...
                      <div class="row">
                         <div class="col-md-12">
                          <label class="form-label" for="">Descrição:</label>
                            <textarea class="form-control" required name="alimento_descricao" id="alimento_descricao" cols="30" rows="4"><?php echo $linha['alimento_descricao'] ?></textarea>
                         </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6">
                              <label class="form-label" for="">Preço(R$):</label>
                              <input class="form-control" name="alimento_preco" id="alimento_preco" type="text" required value="<?php echo $linha['alimento_preco'] ?>">
                          </div>
                          <div class="col-md-6">
                              <label class="form-label" for="">Quantidade disponível:</label>
                              <input class="form-control" name="alimento_disponivel" id="alimento_disponivel" min="0" type="number" required value="<?php echo $linha['alimento_disponivel']?>">
                          </div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <select class="form-control" name="alimento_destaque" id="alimento_destaque">
                                  <option value="<?php echo $linha['alimento_destaque'] ?>"><?php 
                                    $ad = $linha['alimento_destaque'];
          ...
          <div class="card-footer">
              <div class="d-flex flex-row-reverse">
                ...
                <a class="btn btn-danger mr-1" href="excluir.php?alimento=<?php echo $alimento_id ?>">Excluir</a>
              </div>
            </form>
          </div>
        </div>
